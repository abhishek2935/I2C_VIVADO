...
REM
REM Generated by Vivado on Tue Mar 24 14:50:41 +0530 2026
...
echo "xvlog --incr --relax -prj tb_i2c_top_vlog.prj"
call xvlog  --incr --relax -prj tb_i2c_top_vlog.prj -log xvlog.log
